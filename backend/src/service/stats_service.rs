...
pub fn count_games(pool: &Pool) -> Result<i64, (StatusCode, Json<ErrorResponse>)> {
...
pub fn count_scores(id: Option<Uuid>, pool: &Pool) -> Result<i64, (StatusCode, Json<ErrorResponse>)> {
